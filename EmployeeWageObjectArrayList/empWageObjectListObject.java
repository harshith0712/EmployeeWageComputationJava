...
Functionality : program for encapsulating empWageObjectListLogic
class and their members
* */
public class empWageObjectListObject {
    private String CompanyName;
    private int empRatePerHr;
    private int numWorkingDays;
    private int totalWorkingHrs;

    public empWageObjectListObject(String companyName, int empRatePerHr, int numWorkingDays, int totalWorkingHrs) {
